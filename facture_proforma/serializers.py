...
class FactureProformaListSerializer(serializers.ModelSerializer):
...
class FactureProformaLineWriteSerializer(serializers.ModelSerializer):
...
class FactureProformaSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for line_data in lines_data:
            ...
            FactureProFormaLine.objects.create(facture_pro_forma=instance, **line_data)
    ...
    def to_representation(self, instance):
        ...
        representation["lignes"] = FactureProFormaLineSerializer(
...
class FactureProformaDetailSerializer(FactureProformaSerializer):
    """
    ...
    def update(self, instance, validated_data):
        ...
        instance = super(FactureProformaSerializer, self).update(
                ...
                for line_data in lines_data:
                    ...
                    if line_id and line_id in existing_lines:
                        ...
                        FactureProFormaLine.objects.create(
                            facture_pro_forma=instance, **create_data
                        )

                # Delete lines not included in payload
                ids_to_delete = set(existing_lines.keys()) - incoming_ids
                if ids_to_delete:
                    FactureProFormaLine.objects.filter(id__in=ids_to_delete).delete()
